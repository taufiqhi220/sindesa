...
<head>
    ...
    <title>Review Keterangan Usaha - SINDESA</title>
...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-8 lg:ml-[280px] overflow-x-hidden min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold text-[#1a5e35]">Review Detail Keterangan Usaha</h2>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label
                            class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Pekerjaan
                            Saat Ini</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div
                            ...
                            {{ $dataTambahan['alamat_dusun'] ?? '-' }}, RT {{ $dataTambahan['rt'] ?? '-' }} / RW
                            {{ $dataTambahan['rw'] ?? '-' }}
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-store"></i> Rincian Keterangan Usaha
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Jenis
                            Usaha Utama</label>
                        <div
                            class="px-4 py-3 bg-orange-50 border border-orange-100 rounded-xl text-orange-700 font-bold text-lg uppercase tracking-wide">
                            {{ $dataTambahan['jenis_usaha'] ?? '-' }}
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Jenis
                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <span
                                class="text-sm text-gray-800 font-medium">{{ !empty($dataTambahan['file_foto_usaha']) ? 'Berkas Tersedia' : 'Berkas Tidak Dilampirkan' }}</span>
                        </div>
                        @if(!empty($dataTambahan['file_foto_usaha']))
                            <a href="{{ asset('storage/' . $dataTambahan['file_foto_usaha']) }}" target="_blank"
                                class="inline-flex justify-center items-center gap-2 px-6 py-2.5 bg-white border border-[#1a5e35] text-[#1a5e35] rounded-full font-semibold text-sm hover:bg-[#1a5e35] hover:text-white transition-all shadow-sm">
                                <i class="fas fa-cloud-download-alt"></i> Lihat File
                            </a>
                        @else
