...
<head>
    ...
    <title>Review Keterangan Kehilangan - SINDESA</title>
...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-8 lg:ml-[280px] overflow-x-hidden min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold text-[#1a5e35]">Review Detail Keterangan Kehilangan</h2>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-user-tag"></i> Identitas Pelapor
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataTambahan['nik_pelapor'] ?? $surat->user->nik ?? '-' }}
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Tempat
                            Lahir</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataTambahan['tempat_lahir_pelapor'] ?? $surat->user->tempat_lahir ?? '-' }}
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            @php
                                $tanggalLahir = $dataTambahan['tanggal_lahir_pelapor'] ?? $surat->user->tanggal_lahir ?? null;
                            @endphp
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Jenis
                            Kelamin</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataTambahan['jenis_kelamin_pelapor'] ?? $surat->user->jenis_kelamin ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataTambahan['agama_pelapor'] ?? $surat->user->agama ?? 'Islam' }}
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataTambahan['pekerjaan_pelapor'] ?? $surat->user->pekerjaan ?? '-' }}
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <div
                            ...
                            {{ $dataTambahan['alamat_pelapor'] ?? $surat->user->alamat_lengkap ?? '-' }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-10">
                <h3 class="flex items-center gap-2 text-lg font-bold text-red-600 border-b-2 border-gray-50 pb-3 mb-6">
                    <i class="fas fa-search-location"></i> Rincian Barang / Dokumen Hilang
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        <label
                            class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Keterangan
                            Barang yang Hilang</label>
                        <div
                            class="px-4 py-3 bg-red-50 border border-red-100 rounded-xl text-gray-800 font-semibold leading-relaxed">
                            {{ $dataTambahan['rincian_hilang'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Waktu
                            Kehilangan (Perkiraan)</label>
                        <div class="px-4 py-3 bg-red-50 border border-red-100 rounded-xl text-gray-800 font-semibold">
                            {{ !empty($dataTambahan['waktu_hilang']) ? \Carbon\Carbon::parse($dataTambahan['waktu_hilang'])->translatedFormat('d F Y') : '-' }}
                        </div>
                    </div>
                    <div>
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <label
                                ...
                                Kepemilikan Barang/Dokumen</label>
                            <span
                                class="text-sm text-gray-800 font-medium">{{ !empty($dataTambahan['file_bukti']) ? 'Berkas Tersedia' : 'Berkas Tidak Dilampirkan' }}</span>
                        </div>
