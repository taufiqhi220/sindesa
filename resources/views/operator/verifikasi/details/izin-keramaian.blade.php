...
<head>
    ...
    <title>Review Izin Keramaian - SINDESA</title>
...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-8 lg:ml-[280px] overflow-x-hidden min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold text-[#1a5e35]">Review Detail Izin Keramaian</h2>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-user-shield"></i> Identitas Penanggung Jawab
                </h3>
            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div
                            class="px-4 py-3 bg-orange-50 border border-orange-100 rounded-xl text-gray-800 font-semibold">
                            {{ !empty($dataTambahan['tanggal_mulai']) ? \Carbon\Carbon::parse($dataTambahan['tanggal_mulai'])->translatedFormat('d F Y') : '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Tanggal
                        ...
                        <div
                            class="px-4 py-3 bg-orange-50 border border-orange-100 rounded-xl text-gray-800 font-semibold">
                            {{ !empty($dataTambahan['tanggal_selesai']) ? \Carbon\Carbon::parse($dataTambahan['tanggal_selesai'])->translatedFormat('d F Y') : '-' }}
                        </div>
                    </div>
                    <div class="md:col-span-2">
            ...
            <div class="mb-10">
                ...
                <div class="bg-red-50 p-6 rounded-xl border border-red-200 flex items-start gap-4">
                    ...
                    <p class="text-sm text-gray-800 font-medium leading-relaxed">
                        Pemohon telah menyetujui pernyataan untuk menjaga keamanan dan ketertiban. Menjamin <span
                            class="text-red-600 font-bold">tidak akan ada aktivitas Pornografi, Porno Aksi /
