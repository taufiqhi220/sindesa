...
<head>
    ...
    <title>Review Beda Nama - SINDESA</title>
...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    @php
        // Karena sudah di-cast jadi array oleh Laravel, langsung pakai saja
    ...
    <main class="flex-1 p-6 lg:p-8 lg:ml-[280px] overflow-x-hidden min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold text-[#1a5e35]">Review Detail Beda Nama</h2>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    class="flex items-center gap-2 text-lg font-bold text-[#1a5e35] border-b-2 border-gray-50 pb-3 mb-6">
                    <i class="fas fa-check-double"></i> Rincian Kebenaran Data
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label
                            class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Keterangan
                            / Detail Perbedaan</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['data_berbeda'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Acuan
                            Data yang Benar</label>
                        <div
                            class="px-4 py-3 bg-emerald-50 border border-emerald-100 rounded-xl text-emerald-700 font-bold">
            ...
            <div class="mb-10">
                ...
                <div class="space-y-4">
                    ...
                    {{-- File Dokumen yang Berbeda --}}
                    <div
                        class="flex flex-col sm:flex-row sm:items-center gap-4 bg-orange-50 p-4 rounded-2xl border border-orange-100">
                        <div class="flex-1">
                            <label
                                class="block text-[10px] font-bold text-orange-400 uppercase tracking-widest mb-1">Dokumen
                                2 (Yang Berbeda - Ijazah/Akte/dll)</label>
                            <span
                        ...
                        @if(!empty($dataPengajuan['file_dok2']))
                            <a href="{{ asset('storage/' . $dataPengajuan['file_dok2']) }}" target="_blank"
                                class="inline-flex justify-center items-center gap-2 px-6 py-2.5 bg-white border border-[#cfa03f] text-[#cfa03f] rounded-full font-semibold text-sm hover:bg-[#cfa03f] hover:text-white transition-all shadow-sm">
                                <i class="fas fa-cloud-download-alt"></i> Lihat File
                            </a>
                        @else
                            <span class="text-xs text-red-500 italic font-semibold">Tidak ada file</span>
