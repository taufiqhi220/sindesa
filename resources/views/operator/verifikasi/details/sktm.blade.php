...
<head>
    ...
    <title>Review Keterangan Tidak Mampu - SINDESA</title>
...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-8 lg:ml-[280px] overflow-x-hidden min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold text-[#1a5e35]">Review Detail Keterangan Tidak Mampu (SKTM)</h2>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-user"></i> Identitas Yang Bersangkutan
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataTambahan['agama'] ?? $surat->user->agama ?? 'Islam' }}
                        </div>
                    </div>
                    <div>
                        <label
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div
                            ...
                            {{ $dataTambahan['alamat'] ?? $surat->user->alamat_lengkap ?? '-' }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-users"></i> Identitas Kepala Keluarga
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataTambahan['nik_kepala_keluarga'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Nama
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Tanggal
                            Lahir</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ !empty($dataTambahan['tanggal_lahir_kk']) ? \Carbon\Carbon::parse($dataTambahan['tanggal_lahir_kk'])->translatedFormat('d F Y') : '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Jenis
            ...
            <div class="mb-10">
                <h3 class="flex items-center gap-2 text-lg font-bold text-red-600 border-b-2 border-gray-50 pb-3 mb-6">
                    <i class="fas fa-exclamation-triangle"></i> Pernyataan Pemohon
                </h3>
                <div class="bg-red-50 p-6 rounded-xl border border-red-200 flex items-start gap-4">
                    ...
                    <p class="text-sm text-gray-800 font-medium leading-relaxed">
                        Pemohon telah menyatakan dengan sebenar-benarnya bahwa <span
                            class="text-red-600 font-bold">Keluarga tergolong Tidak Mampu (Pra-Sejahtera)</span> dan
                        bersedia mempertanggungjawabkan kebenaran data tersebut.
                    </p>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">KTP
                                Pemohon & Kepala Keluarga</label>
                            <span
                                class="text-sm text-gray-800 font-medium">{{ !empty($dataTambahan['file_ktp']) ? 'Berkas Tersedia' : 'Berkas Tidak Ditemukan' }}</span>
                        </div>
                        @if(!empty($dataTambahan['file_ktp']))
                            <a href="{{ asset('storage/' . $dataTambahan['file_ktp']) }}" target="_blank"
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <label
                                ...
                                Keluarga (KK)</label>
                            <span
                                class="text-sm text-gray-800 font-medium">{{ !empty($dataTambahan['file_kk']) ? 'Berkas Tersedia' : 'Berkas Tidak Ditemukan' }}</span>
                        </div>
                        @if(!empty($dataTambahan['file_kk']))
                            <a href="{{ asset('storage/' . $dataTambahan['file_kk']) }}" target="_blank"
                                class="inline-flex justify-center items-center gap-2 px-6 py-2.5 bg-white border border-[#1a5e35] text-[#1a5e35] rounded-full font-semibold text-sm hover:bg-[#1a5e35] hover:text-white transition-all shadow-sm">
                                <i class="fas fa-cloud-download-alt"></i> Lihat File
                            </a>
                        @else
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <label
                                ...
                                Dusun / RT (Opsional)</label>
                            <span
                                class="text-sm text-gray-800 font-medium">{{ !empty($dataTambahan['file_pengantar']) ? 'Berkas Tersedia' : 'Berkas Tidak Dilampirkan' }}</span>
                        </div>
