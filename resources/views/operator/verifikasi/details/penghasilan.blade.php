...
<head>
    ...
    <title>Review Keterangan Penghasilan - SINDESA</title>
...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-8 lg:ml-[280px] overflow-x-hidden min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold text-[#1a5e35]">Review Detail Keterangan Penghasilan</h2>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-user-tie"></i> Identitas Orang Tua / Wali
                </h3>
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-wallet"></i> Rincian Penghasilan & Tanggungan
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Jumlah
                            Penghasilan / Bulan</label>
                        <div
                            class="px-4 py-3 bg-emerald-50 border border-emerald-100 rounded-xl text-emerald-700 font-bold text-lg">
                            {{ $dataTambahan['jumlah_penghasilan'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Jumlah
                        ...
                        <div
                            ...
                            {{ $dataTambahan['jumlah_tanggungan'] ?? '-' }} Orang
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        <label
                            class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Keperluan
                            Beasiswa / Tanggungan Atas Nama</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataTambahan['nama_tanggungan'] ?? $surat->keperluan ?? '-' }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-10">
                <h3 class="flex items-center gap-2 text-lg font-bold text-red-600 border-b-2 border-gray-50 pb-3 mb-6">
                    <i class="fas fa-exclamation-triangle"></i> Pernyataan Orang Tua / Wali
                </h3>
                <div class="bg-red-50 p-6 rounded-xl border border-red-200 flex items-start gap-4">
                    ...
                    <p class="text-sm text-gray-800 font-medium leading-relaxed">
                        Pemohon telah menyetujui pernyataan bahwa rincian penghasilan tersebut adalah benar. Apabila di
                        kemudian hari ditemukan ketidakbenaran, pemohon bersedia mempertanggungjawabkannya.
                    </p>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <span
                                class="text-sm text-gray-800 font-medium">{{ !empty($dataTambahan['file_anak']) ? 'Berkas Tersedia' : 'Berkas Tidak Dilampirkan' }}</span>
                        </div>
                        @if(!empty($dataTambahan['file_anak']))
                            <a href="{{ asset('storage/' . $dataTambahan['file_anak']) }}" target="_blank"
                                class="inline-flex justify-center items-center gap-2 px-6 py-2.5 bg-white border border-[#1a5e35] text-[#1a5e35] rounded-full font-semibold text-sm hover:bg-[#1a5e35] hover:text-white transition-all shadow-sm">
                                <i class="fas fa-cloud-download-alt"></i> Lihat File
                            </a>
                        @else
