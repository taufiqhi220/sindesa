...
<head>
    ...
    <title>Review Pengantar SKCK - SINDESA</title>
...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-8 lg:ml-[280px] overflow-x-hidden min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold text-[#1a5e35]">Review Detail Pengantar SKCK</h2>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-user-shield"></i> Identitas Pemohon
                </h3>
            ...
            <div class="mb-10">
                <h3 class="flex items-center gap-2 text-lg font-bold text-red-600 border-b-2 border-gray-50 pb-3 mb-6">
                    <i class="fas fa-balance-scale"></i> Pernyataan Hukum & Ketertiban
                </h3>
                <div class="bg-red-50 p-6 rounded-xl border border-red-200 flex items-start gap-4">
                    ...
                    <p class="text-sm text-gray-800 font-medium leading-relaxed">
                        Pemohon telah menyetujui pernyataan resmi bahwa yang bersangkutan <span
                            class="text-red-600 font-bold">tidak pernah terlibat dalam perkara Kepolisian / tindakan
                            kriminal</span>, dan data yang dikirimkan adalah benar.
                    </p>
                </div>
            </div>
