...
<head>
    ...
    <title>Surat Pengantar Izin Keramaian</title>
    <style>
        @page {
            margin: 1cm 2cm;
        }
...
@php
        ...
        $tanggalMulai = isset($data['tanggal_mulai']) ? \Carbon\Carbon::parse($data['tanggal_mulai'])->locale('id')->translatedFormat('l, d F Y')
            : '-';

        $tanggalSelesai = isset($data['tanggal_selesai']) ? \Carbon\Carbon::parse($data['tanggal_selesai'])->locale('id')->translatedFormat('d F Y') : '-';
    @endphp
    ...
    <table class="tabel-identitas">
        <tr>
            ...
            <td><strong>{{ strtoupper($data['nama_penanggung_jawab'] ?? '-') }}</strong></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="col-label">Jenis Keramaian</td>
            <td class="col-titik">:</td>
            <td>{{ $data['jenis_acara'] ?? '-' }}</td>
        </tr>
        <tr>
            <td class="col-label">Mulai Hari/Tanggal</td>
            <td class="col-titik">:</td>
    ...
    <div class="teks-paragraf">
        Yang tersebut namanya diatas diberikan Surat Pengantar untuk mendapatkan Surat Izin Keramaian dari KAPOLSEK
        DUAMPANUA, dan dalam acara tersebut tidak boleh mengadakan Pornografi, Porno Aksi / Candoleng  Edoleng,
        perjudian dan mengkomsumsi minuman Keras yang bertentangan dengan Hukum.
    </div>

    <div class="teks-paragraf">
        Demikian Surat Pengantar ini, kami berikan untuk dipergunakan sebagaimana mestinya.
    </div>
