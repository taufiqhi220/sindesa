...
@php
        ...
        // Menentukan teks berdasarkan jenis pengajuan (Pembuatan / Pembaharuan)
        $tujuanPengajuan = $data['tujuan_pengajuan'] ?? 'Pembuatan';
        $perihalText = ($tujuanPengajuan === 'Pembaharuan') ? 'Pengantar Pembaharuan KK' : 'Pengantar KK';
        $layananText = ($tujuanPengajuan === 'Pembaharuan') ? 'Pembaharuan Kartu Keluarga (KK)' : 'Pembuatan Kartu Keluarga (KK)';

        $rt = str_pad($data['rt'] ?? '0', 3, '0', STR_PAD_LEFT);
        $rw = str_pad($data['rw'] ?? '0', 3, '0', STR_PAD_LEFT);
    @endphp
    ...
    <table class="tabel-tujuan">
        <tr>
            ...
            <td style="width: 40%; text-align: left;">
                ...
                K e p a d a,<br>
                Yth. Kepala Dinas Kependudukan dan<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Catatan Sipil<br>
                Di,-<br>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;P i n r a n g
            </td>
    ...
    <table class="tabel-identitas">
        ...
        <tr>
            <td class="col-label">- Jenis Pekerjaan</td>
            <td class="col-titik">:</td>
        ...
        <tr>
            <td class="col-label">- Nama Kepala Keluarga</td>
            <td class="col-titik">:</td>
        ...
        <tr>
            ...
            <td class="col-titik">:</td>
            <td style="line-height: 1.4;">{{ $data['alamat'] ?? '-' }} RT/RW {{ $rt }}/{{ $rw }}<br>Desa Buttu Sawe Kec.
                Duampanua Kab. Pinrang.</td>
        </tr>
    </table>

    <div class="teks-paragraf">
        Yang tersebut namanya di atas adalah benar warga kami dari
        {{ ucwords(strtolower($pengaturan->nama_desa ?? 'Desa Buttu Sawe')) }} Kecamatan
        {{ ucwords(strtolower($pengaturan->header_2 ?? 'Duampanua')) }} Kabupaten Pinrang, yang bersangkutan mohon
        dilayani <strong>{{ $layananText }}</strong>.
    </div>
