...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-10 overflow-x-hidden">
        ...
        <div class="max-w-3xl mx-auto text-center mb-10">
            <h2 class="text-3xl font-bold text-[#1a5e35] mb-2">Pengajuan Surat Keterangan Penghasilan</h2>
            <p class="text-gray-500">Silakan lengkapi formulir untuk penerbitan surat keterangan penghasilan orang
                tua/wali.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] max-w-4xl mx-auto p-6 md:p-10">
            ...
            <form action="{{ route('warga.form.penghasilan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="jumlah_penghasilan" value="{{ old('jumlah_penghasilan') }}"
                ...
                <div class="mb-8">
                    <label class="block mb-2 text-sm font-medium text-gray-800">Nama Anak / Anggota Keluarga yang
                        Ditanggung</label>
                    <input type="text" name="nama_tanggungan" value="{{ old('nama_tanggungan') }}"
                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                        ...
                        <span id="name-anak" class="text-sm text-gray-500 italic truncate">Belum ada file dipilih</span>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 mt-10 mb-6 bg-red-50 p-4 rounded-xl border border-red-200">
                    ...
                    <label for="consent" class="text-sm text-gray-800 font-medium">
                        Saya menyatakan bahwa rincian penghasilan tersebut adalah benar. Apabila di kemudian hari
                        ditemukan ketidakbenaran, saya siap mempertanggungjawabkannya.
                    </label>
                </div>
