...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-10 overflow-x-hidden">
        ...
        <div class="max-w-3xl mx-auto text-center mb-10">
            <h2 class="text-3xl font-bold text-[#1a5e35] mb-2">Pengajuan Surat Keterangan Belum Menikah</h2>
            <p class="text-gray-500">Silakan lengkapi data diri Anda beserta data kedua orang tua dengan valid.</p>
        </div>
            ...
            <form action="{{ route('warga.form.belum-menikah.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_pemohon" value="{{ Auth::user()->name }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 outline-none text-sm"
                            readonly required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="tempat_lahir_pemohon" value="{{ Auth::user()->tempat_lahir }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 outline-none text-sm"
                            readonly required>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-800">Tanggal Lahir</label>
                        <input type="date" name="tanggal_lahir_pemohon" value="{{ Auth::user()->tanggal_lahir }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 outline-none text-sm"
                            readonly required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="jenis_kelamin_pemohon" value="{{ Auth::user()->jenis_kelamin }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 outline-none text-sm"
                            readonly required>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-800">Agama</label>
                        <input type="text" name="agama_pemohon" value="{{ Auth::user()->agama }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 outline-none text-sm"
                            readonly required>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="pekerjaan_pemohon" value="{{ Auth::user()->pekerjaan }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 outline-none text-sm"
                        readonly required>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <textarea name="alamat_pemohon" rows="2"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50 outline-none text-sm"
                        readonly required>{{ Auth::user()->alamat_lengkap }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" name="nik_bapak" value="{{ old('nik_bapak') }}"
                            placeholder="16 Digit NIK Bapak"
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_bapak" value="{{ old('nama_bapak') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-800">Tempat Lahir</label>
                        <input type="text" name="tempat_lahir_bapak" value="{{ old('tempat_lahir_bapak') }}"
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-800">Tanggal Lahir</label>
                        <input type="date" name="tanggal_lahir_bapak" value="{{ old('tanggal_lahir_bapak') }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] outline-none text-sm"
                            required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <select name="agama_bapak"
                            ...
                            <option value="Islam" {{ old('agama_bapak') == 'Islam' ? 'selected' : '' }}>Islam</option>
                            <option value="Kristen Protestan" {{ old('agama_bapak') == 'Kristen Protestan' ? 'selected' : '' }}>Kristen Protestan</option>
                            <option value="Katolik" {{ old('agama_bapak') == 'Katolik' ? 'selected' : '' }}>Katolik
                            </option>
                            <option value="Hindu" {{ old('agama_bapak') == 'Hindu' ? 'selected' : '' }}>Hindu</option>
                            <option value="Buddha" {{ old('agama_bapak') == 'Buddha' ? 'selected' : '' }}>Buddha</option>
                            <option value="Konghucu" {{ old('agama_bapak') == 'Konghucu' ? 'selected' : '' }}>Konghucu
                            </option>
                        </select>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-800">Pekerjaan</label>
                        <input type="text" name="pekerjaan_bapak" value="{{ old('pekerjaan_bapak') }}"
                ...
                <div class="mb-8">
                    <label class="block mb-2 text-sm font-medium text-gray-800">Alamat Lengkap</label>
                    <textarea name="alamat_bapak" rows="2" placeholder="Dusun / Jalan, RT/RW"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] outline-none text-sm"
                        required>{{ old('alamat_bapak') }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" name="nik_ibu" value="{{ old('nik_ibu') }}" placeholder="16 Digit NIK Ibu"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] outline-none text-sm"
                            required>
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <select name="agama_ibu"
                            ...
                            <option value="Kristen Protestan" {{ old('agama_ibu') == 'Kristen Protestan' ? 'selected' : '' }}>Kristen Protestan</option>
                            ...
                            <option value="Konghucu" {{ old('agama_ibu') == 'Konghucu' ? 'selected' : '' }}>Konghucu
                            </option>
                        </select>
                    </div>
                    <div>
                ...
                <div class="mb-8">
                    <label class="block mb-2 text-sm font-medium text-gray-800">Alamat Lengkap</label>
                    <textarea name="alamat_ibu" rows="2" placeholder="Dusun / Jalan, RT/RW"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] outline-none text-sm"
                ...
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <span id="name-ktp" class="text-sm text-gray-500 italic">Belum ada file dipilih</span>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 mb-6 bg-yellow-50 p-4 rounded-xl border border-yellow-200">
                    ...
                    <label for="consent" class="text-sm text-gray-700">Dengan ini saya menyatakan bahwa data yang
                        dikirimkan adalah benar, saya sungguh berstatus belum menikah, dan siap diproses.</label>
                </div>
