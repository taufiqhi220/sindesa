...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-10 overflow-x-hidden">
        ...
        <div class="max-w-3xl mx-auto text-center mb-10">
            <h2 class="text-3xl font-bold text-[#1a5e35] mb-2">Pengajuan Surat Pengantar KTP</h2>
            <p class="text-gray-500">Silakan lengkapi formulir untuk pembuatan/pembaharuan KTP Anda.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] max-w-4xl mx-auto p-6 md:p-10">
            ...
            <form action="{{ route('warga.form.ktp.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                        ...
                        <span id="name-ktp-lama" class="text-sm text-gray-500 italic truncate">Belum ada file
                            dipilih</span>
                    </div>
                </div>
