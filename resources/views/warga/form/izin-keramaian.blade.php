...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-10 overflow-x-hidden">
        ...
        <div class="max-w-3xl mx-auto text-center mb-10">
            <h2 class="text-3xl font-bold text-[#1a5e35] mb-2">Pengajuan Pengantar Izin Keramaian</h2>
            <p class="text-gray-500">Silakan lengkapi formulir untuk penerbitan surat pengantar izin ke Kapolsek.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] max-w-4xl mx-auto p-6 md:p-10">
            ...
            <form action="{{ route('warga.form.izin-keramaian.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" name="nik_penanggung_jawab"
                            value="{{ old('nik_penanggung_jawab', Auth::user()->nik) }}" placeholder="16 Digit NIK"
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_penanggung_jawab"
                            value="{{ old('nama_penanggung_jawab', Auth::user()->name) }}" placeholder="Sesuai KTP"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <textarea name="alamat" rows="2" placeholder="Dusun / Jalan Tempat Tinggal"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="jenis_acara" value="{{ old('jenis_acara') }}"
                        placeholder="Contoh: Pernikahan / Open Turnamen Sepak Bola"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                        required>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <textarea name="lokasi_acara" rows="2"
                        placeholder="Tuliskan nama tempat/dusun lokasi acara diadakan"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                        required>{{ old('lokasi_acara') }}</textarea>
                </div>
                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                        ...
                        <span id="name-pengantar" class="text-sm text-gray-500 italic truncate">Belum ada file
                            dipilih</span>
                    </div>
                </div>
