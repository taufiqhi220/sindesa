...
<head>
    ...
    <title>Pengajuan Keterangan Domisili - SINDESA</title>
...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-10 overflow-x-hidden">
        ...
        <div class="max-w-3xl mx-auto text-center mb-10 mt-10">
            <h2 class="text-3xl font-bold text-[#1a5e35] mb-2">Edit Pengajuan Keterangan Domisili</h2>
            <p class="text-gray-500">Perbaiki data domisili Anda yang salah atau kurang lengkap.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] max-w-4xl mx-auto p-6 md:p-10">
            ...
            <form action="{{ route('warga.form.domisili.update', $surat->id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" name="nik"
                            value="{{ old('nik', $surat->data_tambahan['nik'] ?? Auth::user()->nik) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="nama"
                            value="{{ old('nama', $surat->data_tambahan['nama'] ?? Auth::user()->name) }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="tempat_lahir"
                            value="{{ old('tempat_lahir', $surat->data_tambahan['tempat_lahir'] ?? Auth::user()->tempat_lahir) }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir"
                            value="{{ old('tanggal_lahir', $surat->data_tambahan['tanggal_lahir'] ?? Auth::user()->tanggal_lahir) }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <select name="jenis_kelamin"
                            ...
                            required>
                            @php $jk = old('jenis_kelamin', $surat->data_tambahan['jenis_kelamin'] ?? Auth::user()->jenis_kelamin); @endphp
                    ...
                    <div>
                        ...
                        <select name="status_perkawinan"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm appearance-none transition-all"
                            required>
                            @php $sp = old('status_perkawinan', $surat->data_tambahan['status_perkawinan'] ?? Auth::user()->status_perkawinan); @endphp
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <select name="agama"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm appearance-none transition-all"
                            required>
                            @php $agm = old('agama', $surat->data_tambahan['agama'] ?? Auth::user()->agama); @endphp
                    ...
                    <div>
                        ...
                        <input type="text" name="kewarganegaraan"
                            value="{{ old('kewarganegaraan', $surat->data_tambahan['kewarganegaraan'] ?? 'Indonesia') }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <input type="text" name="pekerjaan"
                        value="{{ old('pekerjaan', $surat->data_tambahan['pekerjaan'] ?? Auth::user()->pekerjaan) }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                        required>
                </div>

                <h3 class="text-lg font-semibold text-[#1a5e35] border-b-2 border-gray-100 pb-2 mb-6">Alamat Domisili
                </h3>
                ...
                <div class="mb-8">
                    ...
                    <textarea name="alamat" rows="3"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                        required>{{ old('alamat', $surat->data_tambahan['alamat'] ?? Auth::user()->alamat_lengkap) }}</textarea>
                </div>
                ...
                <div
                    ...
                    @if(isset($surat->data_tambahan['file_ktp']))
                        <div class="mb-4 p-3 bg-white border border-gray-200 rounded-xl flex items-center justify-between">
                            ...
                            <a href="{{ asset('storage/' . $surat->data_tambahan['file_ktp']) }}" target="_blank"
                ...
                <div
                    ...
                    <label class="block text-sm font-semibold text-gray-800 mb-1">Upload Dokumen Pendukung Lain
                        (Opsional)</label>
                    <span class="block text-xs text-gray-500 mb-4">Jika ada dokumen penguat lainnya. Maks 5MB. Format:
                        PDF, JPG, PNG.</span>
                ...
                <div class="flex items-start gap-3 mt-10 mb-6 bg-yellow-50 p-4 rounded-xl border border-yellow-200">
                    <input type="checkbox" id="consent" oninvalid="this.setCustomValidity('Harap centang kotak persetujuan ini sebelum melanjutkan.')" oninput="this.setCustomValidity('')"
                        ...
                        required>
                    <label for="consent" class="text-sm text-gray-700">Dengan ini saya menyatakan bahwa data di atas
                        adalah benar, saya memang berdomisili di alamat tersebut, dan data ini siap diproses
                        ulang.</label>
                </div>
