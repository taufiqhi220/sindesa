...
<head>
    ...
    <title>Pengajuan Pengantar SKCK - SINDESA</title>
...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-10 overflow-x-hidden">
        ...
        <div class="max-w-3xl mx-auto text-center mb-10 mt-10">
            <h2 class="text-3xl font-bold text-[#1a5e35] mb-2">Edit Pengajuan Surat Pengantar SKCK</h2>
            <p class="text-gray-500">Perbaiki data atau keperluan pengajuan surat pengantar Kepolisian Anda.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] max-w-4xl mx-auto p-6 md:p-10">
            ...
            <form action="{{ route('warga.form.skck.update', $surat->id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="kewarganegaraan"
                            value="{{ old('kewarganegaraan', $data['kewarganegaraan'] ?? Auth::user()->kewarganegaraan ?? 'Indonesia') }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                        ...
                        <input type="text" name="alamat_dusun"
                            ...
                            placeholder="Contoh: Kamali, Dusun Kamali"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                ...
                <h3 class="text-lg font-semibold text-[#1a5e35] border-b-2 border-gray-100 pb-2 mb-6">Keperluan
                    Pengajuan</h3>
                <div class="mb-8">
                    <label class="block mb-2 text-sm font-medium text-gray-800">Keperluan Pembuatan SKCK</label>
                    <input type="text" name="keperluan"
                        value="{{ old('keperluan', $data['keperluan'] ?? $surat->keperluan) }}"
                        placeholder="Contoh: Persyaratan Melamar Pekerjaan / Melanjutkan Pendidikan"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                        required>
                </div>
                ...
                <div class="flex items-start gap-3 mt-10 mb-6 bg-yellow-50 p-4 rounded-xl border border-yellow-200">
                    ...
                    <label for="consent" class="text-sm text-gray-700">Dengan ini saya menyatakan data yang saya
                        perbarui adalah benar, saya tidak pernah terlibat dalam perkara Kepolisian, dan siap diproses
                        ulang.</label>
                </div>
