...
<body class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
    ...
    <main class="flex-1 p-6 lg:p-10 overflow-x-hidden">
        ...
        <div class="max-w-3xl mx-auto text-center mb-10 mt-10">
            <h2 class="text-3xl font-bold text-[#1a5e35] mb-2">Edit Pengajuan Surat Keterangan Kematian</h2>
            <p class="text-gray-500">Perbaiki data almarhum/almarhumah atau detail kematian yang kurang tepat.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] max-w-4xl mx-auto p-6 md:p-10">
            ...
            <form action="{{ route('warga.form.kematian.update', $surat->id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" name="nik_almarhum"
                            value="{{ old('nik_almarhum', $data['nik_almarhum'] ?? '') }}" placeholder="16 Digit NIK"
                    ...
                    <div>
                        ...
                        <input type="number" name="kk_almarhum"
                            value="{{ old('kk_almarhum', $data['kk_almarhum'] ?? '') }}" placeholder="16 Digit Nomor KK"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama_almarhum"
                        value="{{ old('nama_almarhum', $data['nama_almarhum'] ?? '') }}" placeholder="Sesuai KTP/KK"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                        required>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="tempat_lahir_almarhum"
                            value="{{ old('tempat_lahir_almarhum', $data['tempat_lahir_almarhum'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_lahir_almarhum"
                            value="{{ old('tanggal_lahir_almarhum', $data['tanggal_lahir_almarhum'] ?? '') }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <select name="jenis_kelamin_almarhum"
                            ...
                            required>
                            @php $jk = old('jenis_kelamin_almarhum', $data['jenis_kelamin_almarhum'] ?? ''); @endphp
                    ...
                    <div>
                        ...
                        <select name="agama_almarhum"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm appearance-none transition-all"
                            required>
                            @php $agm = old('agama_almarhum', $data['agama_almarhum'] ?? ''); @endphp
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="kewarganegaraan_almarhum"
                            value="{{ old('kewarganegaraan_almarhum', $data['kewarganegaraan_almarhum'] ?? 'Indonesia') }}"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                    <div>
                        ...
                        <select name="status_perkawinan_almarhum"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm appearance-none transition-all"
                            required>
                            @php $sp = old('status_perkawinan_almarhum', $data['status_perkawinan_almarhum'] ?? ''); @endphp
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="pekerjaan_almarhum"
                        value="{{ old('pekerjaan_almarhum', $data['pekerjaan_almarhum'] ?? '') }}"
                ...
                <div class="mb-8">
                    ...
                    <textarea name="alamat_almarhum" rows="2" placeholder="Dusun / Jalan"
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                        required>{{ old('alamat_almarhum', $data['alamat_almarhum'] ?? '') }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="umur_kematian"
                            value="{{ old('umur_kematian', $data['umur_kematian'] ?? '') }}" placeholder="Contoh: 60"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:border-[#1a5e35] focus:ring-4 focus:ring-[#1a5e35]/10 outline-none text-sm transition-all"
                            required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="sebab_kematian"
                            value="{{ old('sebab_kematian', $data['sebab_kematian'] ?? '') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="hubungan_pelapor"
                            value="{{ old('hubungan_pelapor', $data['hubungan_pelapor'] ?? '') }}"
                ...
                <div
                    ...
                    @if(isset($data['file_ktp_almarhum']))
                        <div class="mb-4 p-3 bg-white border border-gray-200 rounded-xl flex items-center justify-between">
                            ...
                            <a href="{{ asset('storage/' . $data['file_ktp_almarhum']) }}" target="_blank"
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                        <input type="file" id="file-ktp-almarhum" name="file_ktp_almarhum" class="hidden"
                            onchange="updateFileName(this, 'name-ktp-almarhum')">
                        ...
                        <span id="name-ktp-almarhum" class="text-sm text-gray-500 italic truncate">Tidak ada file baru
                            dipilih</span>
                    </div>
                </div>
                ...
                <div
                    ...
                    @if(isset($data['file_kk_almarhum']))
                        <div class="mb-4 p-3 bg-white border border-gray-200 rounded-xl flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-blue-50 text-blue-600 rounded-lg flex items-center justify-center">
                                    <i class="fas fa-file-alt text-lg"></i>
                            ...
                            <a href="{{ asset('storage/' . $data['file_kk_almarhum']) }}" target="_blank"
                                class="text-sm bg-blue-50 text-blue-600 hover:bg-blue-100 px-4 py-2 rounded-lg font-medium transition-colors">
                                <i class="fas fa-eye mr-1"></i> Lihat
                            </a>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                        <input type="file" id="file-kk-almarhum" name="file_kk_almarhum" class="hidden"
                            onchange="updateFileName(this, 'name-kk-almarhum')">
                        <label for="file-kk-almarhum"
                            class="inline-flex justify-center items-center gap-2 px-6 py-2.5 bg-white border border-[#1a5e35] text-[#1a5e35] rounded-full cursor-pointer font-semibold text-sm hover:bg-[#1a5e35] hover:text-white transition-all shadow-sm">
                            <i class="fas fa-cloud-upload-alt"></i> Ganti File
                        </label>
                        <span id="name-kk-almarhum" class="text-sm text-gray-500 italic truncate">Tidak ada file baru
                            dipilih</span>
                    </div>
                </div>
                ...
                <div
                    ...
                    @if(isset($data['file_ktp_pelapor']))
                        <div class="mb-4 p-3 bg-white border border-gray-200 rounded-xl flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-blue-50 text-blue-600 rounded-lg flex items-center justify-center">
                                    <i class="fas fa-file-alt text-lg"></i>
                            ...
                            <a href="{{ asset('storage/' . $data['file_ktp_pelapor']) }}" target="_blank"
                                class="text-sm bg-blue-50 text-blue-600 hover:bg-blue-100 px-4 py-2 rounded-lg font-medium transition-colors">
                                <i class="fas fa-eye mr-1"></i> Lihat
                            </a>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                        <input type="file" id="file-ktp-pelapor" name="file_ktp_pelapor" class="hidden"
                            onchange="updateFileName(this, 'name-ktp-pelapor')">
                        <label for="file-ktp-pelapor"
                            class="inline-flex justify-center items-center gap-2 px-6 py-2.5 bg-white border border-[#1a5e35] text-[#1a5e35] rounded-full cursor-pointer font-semibold text-sm hover:bg-[#1a5e35] hover:text-white transition-all shadow-sm">
                            <i class="fas fa-cloud-upload-alt"></i> Ganti File
                        </label>
                        <span id="name-ktp-pelapor" class="text-sm text-gray-500 italic truncate">Tidak ada file baru
                            dipilih</span>
                    </div>
                </div>
                ...
                <div
                    ...
                    @if(isset($data['file_rs']) && $data['file_rs'])
                        <div class="mb-4 p-3 bg-white border border-gray-200 rounded-xl flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-blue-50 text-blue-600 rounded-lg flex items-center justify-center">
                                    <i class="fas fa-file-alt text-lg"></i>
                            ...
                            <a href="{{ asset('storage/' . $data['file_rs']) }}" target="_blank"
                                class="text-sm bg-blue-50 text-blue-600 hover:bg-blue-100 px-4 py-2 rounded-lg font-medium transition-colors">
                                <i class="fas fa-eye mr-1"></i> Lihat
                            </a>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                        ...
                        <span id="name-rs" class="text-sm text-gray-500 italic truncate">Tidak ada file baru
                            dipilih</span>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3 mt-10 mb-6 bg-yellow-50 p-4 rounded-xl border border-yellow-200">
                    ...
                    <label for="consent" class="text-sm text-gray-700">Keterangan ini dibuat atas dasar yang sebenarnya.
                        Dengan ini saya menyatakan data yang diperbarui siap diproses kembali.</label>
                </div>
