...
<head>
    ...
    <title>Tanda Tangan Ket. Kehilangan - SINDESA</title>
    ...
    <main class="flex-1 p-6 lg:p-8 lg:ml-[280px] overflow-x-hidden min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 font-medium uppercase tracking-wide">
                    Keterangan Kehilangan - {{ $surat->nomor_surat ?? 'NOMOR BELUM DISET' }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <p class="text-sm">Laporan kehilangan ini telah diverifikasi oleh Operator pada
                    {{ $surat->updated_at->translatedFormat('d F Y, H:i') }} WIB. Identitas pelapor dan kronologi
                    kehilangan telah diperiksa kelengkapannya.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-user"></i> Identitas Pelapor
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Tempat
                            Lahir</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['tempat_lahir_pelapor'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Tanggal
                            Lahir</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ !empty($dataPengajuan['tanggal_lahir_pelapor']) ? \Carbon\Carbon::parse($dataPengajuan['tanggal_lahir_pelapor'])->translatedFormat('d F Y') : '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Jenis
                            Kelamin</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['jenis_kelamin_pelapor'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['pekerjaan_pelapor'] ?? '-' }}
                        </div>
                    </div>
            ...
            <div class="mb-10">
                <h3 class="flex items-center gap-2 text-lg font-bold text-red-600 border-b-2 border-gray-50 pb-3 mb-6">
                    <i class="fas fa-search"></i> Rincian Barang/Dokumen yang Hilang
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-red-50 p-6 rounded-xl border border-red-100">
                    <div class="md:col-span-2">
                        <label class="block text-[10px] font-bold text-red-700 uppercase tracking-widest mb-1">Barang /
                            Surat Berharga yang Hilang</label>
                        <div class="text-red-900 font-bold leading-relaxed">
                            {{ $dataPengajuan['rincian_hilang'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-red-700 uppercase tracking-widest mb-1">Waktu
                            Kehilangan (Perkiraan)</label>
                        <div class="text-red-900 font-semibold">
                            {{ !empty($dataPengajuan['waktu_hilang']) ? \Carbon\Carbon::parse($dataPengajuan['waktu_hilang'])->translatedFormat('d F Y') : '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-red-700 uppercase tracking-widest mb-1">Lokasi /
                            Tempat Kehilangan</label>
                        <div class="text-red-900 font-semibold">{{ $dataPengajuan['lokasi_hilang'] ?? '-' }}</div>
                    </div>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <label
                                ...
                                Kepemilikan (Foto Copy / Dokumen Pendukung)</label>
                            <span
