...
<head>
    ...
    <title>Tanda Tangan Keterangan Domisili - SINDESA</title>
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 font-medium uppercase tracking-wide">
                    Keterangan Domisili - {{ $surat->nomor_surat ?? 'NOMOR BELUM DISET' }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <p class="text-sm">Surat ini telah diverifikasi oleh Operator pada
                    {{ $surat->updated_at->translatedFormat('d F Y, H:i') }} WIB. Alamat domisili yang dilaporkan sesuai
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-user-check"></i> Identitas Warga (Pemohon)
                </h3>
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-map-marker-alt"></i> Keterangan Domisili Saat Ini
                </h3>
                <div class="bg-orange-50 p-6 rounded-xl border border-orange-100">
                    <label class="block text-[10px] font-bold text-orange-700 uppercase tracking-widest mb-2">Alamat
                        Lengkap Domisili</label>
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <label
                                ...
                                Dusun / RT / Dokumen Tambahan</label>
                            <span
