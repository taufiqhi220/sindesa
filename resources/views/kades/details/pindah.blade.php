...
<head>
    ...
    <title>Tanda Tangan Ket. Pindah - SINDESA</title>
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 font-medium uppercase tracking-wide">
                    Keterangan Pindah - {{ $surat->nomor_surat ?? 'NOMOR BELUM DISET' }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <p class="text-sm">Surat ini telah diverifikasi oleh Operator pada
                    {{ $surat->updated_at->translatedFormat('d F Y, H:i') }} WIB. Alamat tujuan kepindahan dan
                    kelengkapan dokumen telah diperiksa dan sah.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-user-circle"></i> Identitas Pemohon (Kepala Keluarga)
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Nomor
                    ...
                    <div class="md:col-span-3">
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Nama
                            Lengkap</label>
                        <div
                            class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-bold text-lg">
                            {{ $dataPengajuan['nama'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Status
                            Perkawinan</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['status_perkawinan'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label
                    ...
                    <div class="md:col-span-3">
                        <label
                            class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Pendidikan</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['pendidikan'] ?? '-' }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- DETAIL KEPINDAHAN -->
            <div class="mb-10">
                <h3 class="flex items-center gap-2 text-lg font-bold text-blue-600 border-b-2 border-blue-50 pb-3 mb-6">
                    <i class="fas fa-truck-moving"></i> Keterangan Kepindahan
                </h3>
                ...
                <div class="mb-6">
                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Alamat
                        Asal</label>
                    <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                        {{ $dataPengajuan['alamat_asal_dusun'] ?? ($dataPengajuan['alamat_asal']['dusun'] ?? '-') }},
                        RT {{ $dataPengajuan['alamat_asal_rt'] ?? ($dataPengajuan['alamat_asal']['rt'] ?? '-') }} /
                        RW {{ $dataPengajuan['alamat_asal_rw'] ?? ($dataPengajuan['alamat_asal']['rw'] ?? '-') }},
                        Desa Buttu Sawe
                    </div>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 bg-blue-50 p-6 rounded-xl border border-blue-100">
                    <div class="md:col-span-4 mb-2 border-b border-blue-200/50 pb-2">
                        <span class="text-blue-800 font-bold text-sm uppercase tracking-wider"><i
                                class="fas fa-map-marker-alt"></i> Alamat Tujuan Pindah</span>
                    </div>
                    <div class="md:col-span-4">
                        <label class="block text-[10px] font-bold text-blue-700 uppercase tracking-widest mb-1">Jalan /
                            Dusun / Kampung</label>
                        <div class="text-blue-900 font-bold text-lg">
                            {{ $dataPengajuan['alamat_tujuan_jalan'] ?? ($dataPengajuan['alamat_tujuan']['jalan'] ?? '-') }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-blue-700 uppercase tracking-widest mb-1">RT /
                            RW</label>
                        <div class="text-blue-900 font-semibold">
                            {{ $dataPengajuan['alamat_tujuan_rt'] ?? ($dataPengajuan['alamat_tujuan']['rt'] ?? '-') }} /
                            {{ $dataPengajuan['alamat_tujuan_rw'] ?? ($dataPengajuan['alamat_tujuan']['rw'] ?? '-') }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-blue-700 uppercase tracking-widest mb-1">Desa /
                            Kelurahan</label>
                        <div class="text-blue-900 font-semibold">
                            {{ $dataPengajuan['alamat_tujuan_desa'] ?? ($dataPengajuan['alamat_tujuan']['desa'] ?? '-') }}
                        </div>
                    </div>
                    <div>
                        <label
                            class="block text-[10px] font-bold text-blue-700 uppercase tracking-widest mb-1">Kecamatan</label>
                        <div class="text-blue-900 font-semibold">
                            {{ $dataPengajuan['alamat_tujuan_kecamatan'] ?? ($dataPengajuan['alamat_tujuan']['kecamatan'] ?? '-') }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-blue-700 uppercase tracking-widest mb-1">Kab /
                            Kota</label>
                        <div class="text-blue-900 font-semibold">
                            {{ $dataPengajuan['alamat_tujuan_kabupaten'] ?? ($dataPengajuan['alamat_tujuan']['kabupaten'] ?? '-') }}
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        <label
                            class="block text-[10px] font-bold text-blue-700 uppercase tracking-widest mb-1">Provinsi</label>
                        <div class="text-blue-900 font-semibold">
                            {{ $dataPengajuan['alamat_tujuan_provinsi'] ?? ($dataPengajuan['alamat_tujuan']['provinsi'] ?? '-') }}
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-[10px] font-bold text-blue-700 uppercase tracking-widest mb-1">Kode
                            Pos</label>
                        <div class="text-blue-900 font-semibold">
                            {{ $dataPengajuan['alamat_tujuan_kodepos'] ?? ($dataPengajuan['alamat_tujuan']['kode_pos'] ?? '-') }}
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Alasan
                            Pindah</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['alasan_pindah'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Rencana
                            Tanggal Pindah</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-bold">
                            {{ !empty($dataPengajuan['tanggal_pindah']) ? \Carbon\Carbon::parse($dataPengajuan['tanggal_pindah'])->translatedFormat('d F Y') : '-' }}
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2 mt-2">
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Daftar
                            Anggota Keluarga yang Ikut Pindah</label>
                        @php
                            $p_nama = $dataPengajuan['pengikut_nama'] ?? [];
                            ...
                            <div class="overflow-x-auto rounded-xl border border-gray-200 shadow-sm">
                                <table class="w-full text-left text-sm whitespace-nowrap">
                                    <thead class="bg-gray-100 text-gray-500 uppercase tracking-wider text-xs">
                                        <tr>
                                            <th class="px-4 py-3 font-bold border-b border-gray-200 w-10 text-center">No
                                            </th>
                                        ...
                                        @for($i = 0; $i < $countPengikut; $i++)
                                            <tr class="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td class="px-4 py-3 font-bold text-gray-800">
                                                    {{ $dataPengajuan['pengikut_nama'][$i] ?? '-' }}
                                                </td>
                                                <td class="px-4 py-3 text-gray-600 font-mono text-xs">
                                                    {{ $dataPengajuan['pengikut_nik'][$i] ?? '-' }}
                                                </td>
                                                <td class="px-4 py-3 text-gray-600 font-bold">
                                                    {{ substr($dataPengajuan['pengikut_jk'][$i] ?? '-', 0, 1) }}
                                                </td>
                                                <td class="px-4 py-3 text-gray-600">
                                                    {{ !empty($dataPengajuan['pengikut_tgl_lahir'][$i]) ? \Carbon\Carbon::parse($dataPengajuan['pengikut_tgl_lahir'][$i])->format('d/m/Y') : '-' }}
                                                </td>
                                                <td class="px-4 py-3 text-gray-600">
                                                    {{ $dataPengajuan['pengikut_status'][$i] ?? '-' }}
                                                </td>
                                                <td class="px-4 py-3 text-gray-600"><span
                                                        class="bg-gray-100 px-2 py-1 rounded-md text-xs font-semibold">{{ $dataPengajuan['pengikut_ket'][$i] ?? '-' }}</span>
                                                </td>
                                            </tr>
                                        @endfor
                                    </tbody>
                        ...
                        @else
                            <div class="px-4 py-6 bg-gray-50 border border-dashed border-gray-300 rounded-xl text-center">
                                <p class="text-sm text-gray-500 italic">Tidak ada anggota keluarga yang ikut pindah (Pindah
                                    Sendiri).</p>
                            </div>
                        @endif
                    </div>
            ...
            <div class="mb-10">
                ...
                <div class="space-y-4">
                    <div
                        ...
                        <div class="flex-1">
                            <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">KTP
                                Pemohon</label>
                            <span
                                class="text-sm text-gray-800 font-medium">{{ !empty($dataPengajuan['file_ktp']) ? 'Berkas Tersedia' : 'Berkas Tidak Ditemukan' }}</span>
                        </div>
                        @if(!empty($dataPengajuan['file_ktp']))
                            <a href="{{ asset('storage/' . $dataPengajuan['file_ktp']) }}" target="_blank"
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <label
                                class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Kartu
                                Keluarga (KK Asli)</label>
                            <span
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <span
                                class="text-sm text-gray-800 font-medium">{{ !empty($dataPengajuan['file_lain']) ? 'Berkas Tersedia' : 'Berkas Tidak Dilampirkan' }}</span>
                        </div>
                        @if(!empty($dataPengajuan['file_lain']))
                            <a href="{{ asset('storage/' . $dataPengajuan['file_lain']) }}" target="_blank"
                                class="inline-flex justify-center items-center gap-2 px-6 py-2.5 bg-white border border-[#1a5e35] text-[#1a5e35] rounded-full font-semibold text-sm hover:bg-[#1a5e35] hover:text-white transition-all shadow-sm">
                                <i class="fas fa-cloud-download-alt"></i> Lihat File
                            </a>
                        @else
