...
<head>
    ...
    <title>Tanda Tangan Ket. Usaha - SINDESA</title>
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 font-medium uppercase tracking-wide">
                    Keterangan Usaha - {{ $surat->nomor_surat ?? 'NOMOR BELUM DISET' }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <p class="text-sm">Surat ini telah diverifikasi oleh Operator pada
                    {{ $surat->updated_at->translatedFormat('d F Y, H:i') }} WIB. Kepemilikan usaha dan lokasi
                    operasional telah dipastikan sesuai dengan wilayah desa.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-user-tie"></i> Identitas Pemilik Usaha
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-3">
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Alamat
                            Domisili Pemilik</label>
                        <div
                            class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold leading-relaxed">
                            {{ $dataPengajuan['alamat_dusun'] ?? '-' }}, RT
                            {{ str_pad($dataPengajuan['rt'] ?? '0', 3, '0', STR_PAD_LEFT) }} / RW
                            {{ str_pad($dataPengajuan['rw'] ?? '0', 3, '0', STR_PAD_LEFT) }}, Desa Buttu Sawe
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-store"></i> Keterangan Usaha
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-orange-50 p-6 rounded-xl border border-orange-100">
                    <div class="md:col-span-2">
                        <label class="block text-[10px] font-bold text-orange-700 uppercase tracking-widest mb-1">Jenis
                            Usaha Utama</label>
                        <div class="text-orange-900 font-bold text-xl uppercase tracking-wide">
                            {{ $dataPengajuan['jenis_usaha'] ?? '-' }}
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-[10px] font-bold text-orange-700 uppercase tracking-widest mb-1">Jenis
                            Usaha Sampingan</label>
                        <div class="text-orange-900 font-semibold">
                            {{ $dataPengajuan['usaha_sampingan'] ?? 'Tidak Ada' }}
                        </div>
                    </div>
                    <div class="md:col-span-2 mt-2 pt-4 border-t border-orange-200">
                        <label class="block text-[10px] font-bold text-orange-700 uppercase tracking-widest mb-1">Alamat
                            Tempat Usaha Beroperasi</label>
                        <div class="text-orange-900 font-bold leading-relaxed">
                            {{ $dataPengajuan['alamat_usaha'] ?? '-' }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-10">
                ...
                <div class="space-y-4">
                    ...
                    <div
                        class="flex flex-col sm:flex-row sm:items-center gap-4 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                        <div class="flex-1">
                            <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Foto
                                Tempat Usaha (Opsional)</label>
                            <span
                                class="text-sm text-gray-800 font-medium">{{ !empty($dataPengajuan['file_foto_usaha']) ? 'Berkas Tersedia' : 'Berkas Tidak Dilampirkan' }}</span>
                        </div>
                        @if(!empty($dataPengajuan['file_foto_usaha']))
                            <a href="{{ asset('storage/' . $dataPengajuan['file_foto_usaha']) }}" target="_blank"
                                class="inline-flex justify-center items-center gap-2 px-6 py-2.5 bg-white border border-[#1a5e35] text-[#1a5e35] rounded-full font-semibold text-sm hover:bg-[#1a5e35] hover:text-white transition-all shadow-sm">
