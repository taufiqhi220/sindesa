...
<head>
    ...
    <title>Detail Keterangan Belum Menikah - SINDESA</title>
...
< class="font-['Poppins'] bg-[#f4f6f9] flex min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 font-medium uppercase tracking-wide">
                    Keterangan Belum Menikah - {{ $surat->nomor_surat ?? 'NOMOR BELUM DISET' }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <p class="text-sm">Surat ini telah diverifikasi keabsahannya oleh Operator pada
                    {{ $surat->updated_at->translatedFormat('d F Y, H:i') }} WIB. Seluruh berkas dan pernyataan
                    dinyatakan lengkap.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-user"></i> Identitas Pemohon (Yang Belum Menikah)
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Jenis
                            Kelamin</label>
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['jenis_kelamin_pemohon'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['pekerjaan_pemohon'] ?? '-' }}
                        </div>
                    </div>
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-male"></i> Data Bapak Kandung
                </h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-1">
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">NIK
                    ...
                    <div>
                        ...
                        <div
                            class="px-4 py-3 bg-orange-50 border border-orange-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['tempat_lahir_bapak'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Tanggal
                        ...
                        <div
                            class="px-4 py-3 bg-orange-50 border border-orange-100 rounded-xl text-gray-800 font-semibold">
                            {{ !empty($dataPengajuan['tanggal_lahir_bapak']) ? \Carbon\Carbon::parse($dataPengajuan['tanggal_lahir_bapak'])->translatedFormat('d F Y') : '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Agama &
                            Pekerjaan</label>
                        <div
                            class="px-4 py-3 bg-orange-50 border border-orange-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['agama_bapak'] ?? '-' }} - {{ $dataPengajuan['pekerjaan_bapak'] ?? '-' }}
                        </div>
                    </div>
                    <div class="md:col-span-3">
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Alamat
            ...
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div
                            class="px-4 py-3 bg-orange-50 border border-orange-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['tempat_lahir_ibu'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Tanggal
                        ...
                        <div
                            class="px-4 py-3 bg-orange-50 border border-orange-100 rounded-xl text-gray-800 font-semibold">
                            {{ !empty($dataPengajuan['tanggal_lahir_ibu']) ? \Carbon\Carbon::parse($dataPengajuan['tanggal_lahir_ibu'])->translatedFormat('d F Y') : '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Agama &
                        ...
                        <div
                            class="px-4 py-3 bg-orange-50 border border-orange-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['agama_ibu'] ?? '-' }} - {{ $dataPengajuan['pekerjaan_ibu'] ?? '-' }}
                        </div>
                    </div>
                    <div class="md:col-span-3">
                        <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Alamat
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <label
                                ...
                                Pendukung (Surat Pernyataan, dll)</label>
                            <span
