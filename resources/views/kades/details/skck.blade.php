...
<head>
    ...
    <title>Tanda Tangan Pengantar SKCK - SINDESA</title>
    ...
    <main class="flex-1 p-6 lg:p-8 lg:ml-[280px] overflow-x-hidden min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 font-medium uppercase tracking-wide">
                    Pengantar SKCK - {{ $surat->nomor_surat ?? 'NOMOR BELUM DISET' }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <p class="text-sm">Permohonan ini telah diverifikasi oleh Operator pada
                    {{ $surat->updated_at->translatedFormat('d F Y, H:i') }} WIB. Identitas dan catatan kepolisian
                    pemohon dinyatakan bersih dari masalah hukum di tingkat desa.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    class="flex items-center gap-2 text-lg font-bold text-[#cfa03f] border-b-2 border-gray-50 pb-3 mb-4">
                    <i class="fas fa-file-contract"></i> Keperluan Pengajuan SKCK
                </h3>
                <div class="bg-orange-50 border border-orange-100 p-6 rounded-xl">
                    <div class="text-orange-900 font-bold text-lg leading-relaxed">
