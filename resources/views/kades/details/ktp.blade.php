...
<head>
    ...
    <title>Tanda Tangan Pengantar KTP - SINDESA</title>
    ...
    <main class="flex-1 p-6 lg:p-8 lg:ml-[280px] overflow-x-hidden min-h-screen">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 font-medium uppercase tracking-wide">
                    Pengantar KTP - {{ $surat->nomor_surat ?? 'NOMOR BELUM DISET' }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div>
                ...
                <p class="text-sm">Pengajuan surat pengantar KTP ini telah diverifikasi oleh Operator pada
                    {{ $surat->updated_at->translatedFormat('d F Y, H:i') }} WIB. Seluruh data kependudukan telah
        ...
        <div class="bg-white rounded-2xl shadow-[0_5px_20px_rgba(0,0,0,0.05)] border border-gray-100 p-6 md:p-10">
            ...
            <div class="mb-10">
                <h3
                    ...
                    <i class="fas fa-id-card"></i> Data Kependudukan Pemohon
                </h3>
                <div
                    class="grid grid-cols-1 md:grid-cols-3 gap-6 bg-blue-50/30 p-6 rounded-xl border border-blue-100/50">
                    <div class="md:col-span-1">
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">NIK
                            Pemohon</label>
                        <div class="px-4 py-3 bg-white border border-gray-100 rounded-xl text-gray-800 font-bold">
                            {{ $dataPengajuan['nik'] ?? '-' }}
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Nomor
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Tempat
                            Lahir</label>
                        <div class="px-4 py-3 bg-white border border-gray-100 rounded-xl text-gray-800 font-semibold">
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Tanggal
                            Lahir</label>
                        <div class="px-4 py-3 bg-white border border-gray-100 rounded-xl text-gray-800 font-semibold">
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Jenis
                            Kelamin</label>
                        <div class="px-4 py-3 bg-white border border-gray-100 rounded-xl text-gray-800 font-semibold">
                    ...
                    <div>
                        <label
                            class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Agama</label>
                        <div class="px-4 py-3 bg-white border border-gray-100 rounded-xl text-gray-800 font-semibold">
                            {{ $dataPengajuan['agama'] ?? '-' }}
                        </div>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Status
                            Perkawinan</label>
                        <div class="px-4 py-3 bg-white border border-gray-100 rounded-xl text-gray-800 font-semibold">
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">KTP
                                Lama / Surat Kehilangan (Jika ada)</label>
                            <span
                                class="text-sm text-gray-800 font-medium">{{ !empty($dataPengajuan['file_ktp_lama']) ? 'Berkas Tersedia' : 'Berkas Tidak Dilampirkan (Pembuatan Baru)' }}</span>
                        </div>
                        @if(!empty($dataPengajuan['file_ktp_lama']))
                            <a href="{{ asset('storage/' . $dataPengajuan['file_ktp_lama']) }}" target="_blank"
                                class="inline-flex justify-center items-center gap-2 px-6 py-2.5 bg-white border border-[#1a5e35] text-[#1a5e35] rounded-full font-semibold text-sm hover:bg-[#1a5e35] hover:text-white transition-all shadow-sm">
                                <i class="fas fa-cloud-download-alt"></i> Lihat File
                            </a>
                        @else
